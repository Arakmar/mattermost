...
func TestCreateOAuthUser(t *testing.T) {
	...
	t.Run("create user successfully", func(t *testing.T) {
		glUser := oauthgitlab.GitLabUser{Username: "o" + model.NewId(), Email: model.NewId() + "@simulator.amazonses.com", Name: "Joram Wilander"}
...
func TestUpdateOAuthUserAttrs(t *testing.T) {
	...
	user, gitlabUserObj = createGitlabUser(t, th.App, th.Context, username, email)
	user2, _ = createGitlabUser(t, th.App, th.Context, username2, email2)
...
func createGitlabUser(t *testing.T, a *App, c request.CTX, username string, email string) (*model.User, oauthgitlab.GitLabUser) {
	gitlabUserObj := oauthgitlab.GitLabUser{Username: username, Login: "user1", Email: email, Name: "Test User"}
	gitlabUser := getGitlabUserPayload(gitlabUserObj, t)
